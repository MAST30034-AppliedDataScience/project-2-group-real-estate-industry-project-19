...
'''Balwyn+North/3104', 'Balwyn/3103', 'Camberwell/3124', 
    'Glen+Iris/3146', 'Hawthorn+East/3123', 'Kew+East/3102', 'Surrey+Hills/3127', 
    'Hawthorn/3122', 'Kew/3101', 'Bulleen/3105', 'Doncaster/3108', 
...
OUTPUT_FILE = 'data/landing/rental_history_scrape.csv'
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                for listing in property_listings:
                    ...
                    last_advertised_price_tag = listing.find('div', class_='price')
                    last_advertised_price = last_advertised_price_tag.text.strip() if last_advertised_price_tag else 'N/A'
                    ...
                    all_properties.append({
                        ...
                        'Last Advertised Price': last_advertised_price,
...
urls = test_urls(N_PAGES, SUBRUBS)
property_data = scrape_oldlistings_data(urls)
save_data_to_csv(property_data, OUTPUT_FILE)